...
public class StrUtil {
     ...
     * @修改记录：<br>
     * @==============================================================<br>
     * @日期:Dec 22, 2009      panchh         创建方法，并实现其功能<br>
     *
     * @==============================================================<br>
     */
    public static String collectionToDelimitedString(Collection<Object> coll,
                                                     String delim) {
     ...
     *
     * ==============================================================<br>
     * 日期:Mar 12, 2009 panchh 创建方法，并实现其功能
     *
     * ==============================================================<br>
     */
    public static Object readXml(String xml, Class<Object> clazz) throws Exception {
        Object obj = null;
        byte[] temp = xml.getBytes();
        String xml2 = new String(temp, "gbk");
        Reader r = new StringReader(xml2);
        obj = Unmarshaller.unmarshal(clazz, r);
        return obj;
    }
     ...
     * ==============================================================<br>
     */
    public static String writeXml(Object obj) throws Exception {
        Writer inputParam = new StringWriter();
        Marshaller.marshal(obj, inputParam);
