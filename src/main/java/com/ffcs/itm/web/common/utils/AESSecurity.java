...
import com.ffcs.itm.common.exception.AppException;
...
public class AESSecurity
{
    ...
    public static String encode(String str, String key, String mode,
            String padding) throws AppException
    {
        ...
        try
        {
            ...
            return ByteUtil.byte2hex(b);
        }
        catch (Exception e)
        {
            throw new AppException("AES加密错误", e);
        }
    }
            ...
            String padding) throws AppException
    {
        ...
        {
            throw new AppException("AES解密错误", e);
        }
    }
    ...
    public static String decode(String str, String key, String mode,
            String padding,String encodeType) throws AppException
    {
        Key secretKey = getKey(key);
        Cipher cipher;
        try
        {
            byte[] b = ByteUtil.hex2byte(str,encodeType);
            cipher = Cipher.getInstance(getSecurityType(mode, padding));
            cipher.init(Cipher.DECRYPT_MODE, secretKey);
            return new String(cipher.doFinal(b));
        }
